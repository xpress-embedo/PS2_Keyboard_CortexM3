 ...
 * 				NVIC firmware library on LPC13xx. The main
 ...
 * - Disable Interrupt (32 IRQ interrupt sources that matched with LPC13xx)
 * - Clear all Pending Interrupts (32 IRQ interrupt source that matched with LPC13xx)
 * - Clear all Interrupt Priorities (32 IRQ interrupt source that matched with LPC13xx)
 *******************************************************************************/
