 ...
 * @{
 */
#ifndef __LPC13XX_TIMER_H_
#define __LPC13XX_TIMER_H_
...
#define PARAM_TIMx(n)	((((uint32_t *)n)==((uint32_t *)LPC_TMR16B0)) \
						|| (((uint32_t *)n)==((uint32_t *)LPC_TMR16B1)) \
						|| (((uint32_t *)n)==((uint32_t *)LPC_TMR32B0)) \
