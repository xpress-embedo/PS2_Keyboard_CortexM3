 ...
 * 				support for I2C firmware library on LPC13xx
 * @version	: 1.0
 * @date	: 13. Apr. 2009
 * @author	: HieuNguyen
 **************************************************************************
...
#ifndef LPC13XX_I2C_H_
#define LPC13XX_I2C_H_
...
#define PARAM_i2c(n)	((((uint32_t *)n)==((uint32_t *)I2C0)) \
...
Status I2C_SlaveTransferData(LPC_I2C_TypeDef *i2c, \
...
uint8_t I2C_GetLastStatusCode(LPC_I2C_TypeDef* i2c);
