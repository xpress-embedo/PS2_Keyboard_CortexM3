 ...
 * 				support for SSP firmware library on LPC13xx
 * @version	: 1.0
 * @date	: 9. April. 2009
 * @author	: HieuNguyen
 **************************************************************************
...
#ifndef LPC13XX_SSP_H_
#define LPC13XX_SSP_H_
...
#define PARAM_ssp_dev(n)	((((uint32_t *)n)==((uint32_t *)SSP0)) \
...
void SSP_DMACmd(LPC_SSP_TypeDef *ssp_dev, uint32_t DMAMode, FunctionalState NewState);
